export default {
    ...
    "approach": {
        ...
        "steps": {
            "discovery": {
                "title": "Скоп та пріоритети",
                "desc": "Цілі, користувачі, обмеження. Фіксуємо скоп, бюджет і критерії успіху."
            },
            "sprint": {
                "title": "Дизайн і розробка",
                "desc": "UX‑флоу, архітектура та інкрементальні релізи кожні 1–2 тижні."
            },
            "zero_defects": {
                "title": "Контроль якості",
                "desc": "Автотести, рев’ю та базові практики безпеки на кожен реліз."
            },
            "scale_ready": {
                "title": "Запуск і підтримка",
                "desc": "Хмара, моніторинг і покращення після релізу."
            }
        }
    },
    "dashboard": {
    ...
    "stack": {
        ...
        "items": {
            "php": { "name": "PHP 8.4", "desc": "ядро backend" },
            "frameworks": { "name": "Laravel / Symfony", "desc": "перевірені фреймворки" },
            "frontend": { "name": "Vue 3 SPA / TypeScript", "desc": "сучасний фронтенд" },
            "realtime": { "name": "Go / Node.js", "desc": "real‑time та воркери" },
            "db": { "name": "PostgreSQL", "desc": "надійне зберігання" },
            "cache": { "name": "Redis", "desc": "кеш та черги" },
            "infra": { "name": "Docker / K8s", "desc": "інфраструктура та деплой" }
        },
        "cats": {
