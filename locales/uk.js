export default {
    ...
    "hero": {
        ...
        "description": "Проєктуємо і запускаємо продакшн‑готові сайти та платформи з чітким обсягом робіт, прогнозованими термінами і підтримкою після релізу. API‑first за замовчуванням.",
    ...
    "dashboard": {
        ...
        "title": "Live Studio",
        "description": "Платформа для онлайн‑трансляцій від Filkx: субсекундна затримка, білінг, аналітика та адмін‑інструменти. Працює в продакшні.",
    ...
    "why": {
        "title": "Чому Filkx",
        "points": [
            { "title": "Чітка відповідальність і результат", "desc": "Ви отримуєте робочий продукт, доступи й документацію — не просто код." },
            { "title": "Передбачуваний процес", "desc": "Фіксований скоп на спринт, щотижневі демо, прозорий бюджет." },
            { "title": "Оперуємо власним продуктом", "desc": "Маємо продакшн‑досвід на live.filkx.com і переносимо його у ваш проєкт." },
            { "title": "Підтримка включена", "desc": "Пів року допомоги зі стабільністю після запуску." }
        ],
